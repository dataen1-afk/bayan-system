...
def generate_stage1_audit_plan_pdf(plan_data: dict) -> bytes:
    ...
    def draw_official_header(title_en="STAGE 1 AUDIT PLAN", title_ar="خطة تدقيق المرحلة الأولى"):
        ...
        c.drawRightString(width - 40, height - 25, "BACF6-07")
    ...
    def draw_official_footer(page_num=1):
        ...
        c.drawCentredString(width / 2, footer_y - 30, f"Page {page_num} | BACF6-07")
    ...
    y = draw_official_header("STAGE 1 AUDIT PLAN", "خطة تدقيق المرحلة الأولى")
