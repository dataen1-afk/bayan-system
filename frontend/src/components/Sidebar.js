  ...
  return (
    <>
      ...
      <aside
        data-testid="sidebar"
        className={cn(
          "sidebar-container fixed h-[calc(100vh-64px)] bg-white border-gray-200 shadow-lg z-30 transition-all duration-300 flex flex-col border-t-4 border-t-blue-700",
        ...
        style={{
          top: '64px', // Connect with header's blue border
        }}
      >
        ...
        <button
          ...
          className={cn(
            "hidden lg:flex absolute top-4 w-6 h-6 bg-white border border-gray-300 rounded-full items-center justify-center shadow-md hover:bg-gray-50 transition-colors",
        ...
        <div className={cn(
          ...
          {!isCollapsed ? (
            <div className={cn("flex items-center gap-2", isRTL && "flex-row-reverse")}>
              <div className="w-8 h-8 bg-bayan-blue rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">B</span>
              </div>
              <span className="font-semibold text-gray-800 text-sm">{t('navigation')}</span>
            </div>
          ) : (
            <div className="w-8 h-8 bg-bayan-blue rounded-lg flex items-center justify-center mx-auto">
              <span className="text-white font-bold text-sm">B</span>
            </div>
          )}
        </div>
