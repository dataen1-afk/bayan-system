  ...
  return (
    <>
      ...
      <aside
        data-testid="sidebar"
        className={cn(
          "sidebar-container fixed h-[calc(100vh-72px)] bg-white border-gray-200 shadow-lg z-30 transition-all duration-300 flex flex-col",
      ...
      >
        ...
        <button
          ...
          className={cn(
            "hidden lg:flex absolute top-24 w-6 h-6 bg-white border border-gray-300 rounded-full items-center justify-center shadow-md hover:bg-gray-50 transition-colors",
