...
import { Pen, Eraser, Upload, RotateCcw, Check, X, PenLine } from 'lucide-react';

// Custom Pen with Plus Sign Icon for Signature Prompt
const PenPlusIcon = ({ className }) => (
  <svg 
    className={className}
    viewBox="0 0 64 64" 
    fill="none" 
  ...
  >
    {/* Pen body */}
    <path 
      d="M45 8L56 19L24 51L10 54L13 40L45 8Z" 
      stroke="currentColor" 
      strokeWidth="2.5" 
      strokeLinecap="round" 
