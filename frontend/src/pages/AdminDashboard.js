            ...
            <DataTable
              ...
              renderRow={(contract, index) => (
                ...
                >
                  ...
                  {/* Date */}
                  <div className={`lg:w-[12%] hidden lg:block ${isRTL ? 'text-right' : 'text-left'}`}>
                    <div className={`flex items-center gap-1 text-sm text-slate-500 ${isRTL ? 'flex-row-reverse justify-end' : ''}`}>
                      <Calendar className="w-3.5 h-3.5" />
                  ...
                  {/* Actions */}
                  <div className={`lg:w-[12%] flex items-center gap-2 mt-3 lg:mt-0 ${isRTL ? 'flex-row-reverse justify-end' : 'justify-end'}`}>
